<template>
  <main>
    <div class="signup">
      <div class="roll-the-carpet">Roll the Carpet.!</div>
      ...
      <div class="frame-2">
        <div class="frame-5">
          <div class="frame-4">
            <div class="upper-section">
              <div class="login-text">
                <div class="signup2">Signup</div>

                <div class="just-some-details-to-get-you-in">
              ...
              <div class="credentials">
                <form role="form" @submit.prevent="sendForm">
                  <v-text-field :rules="[rules.required]" type="text" class="mb-3" placeholder="Username"
                    id="new-username" label="Username" v-model="user.username" dark />


                  <v-text-field v-model="user.email" :rules="emailRules" label="E-mail" required class="mb-3"
                    placeholder="e-mail" id="new-email" type="email" dark />
                  ...
                  <div class="login-bt-fp">
                    <v-btn class="ma-2 login" :loading="loading" :disabled="loading" color="dark" @click="sendForm">
                      <div class="login white--text">Signup</div>
            ...
            <div class="other-logins">
              ...
              <div class="frame-3">
                <svg class="devicon-google" width="42" height="42" viewBox="0 0 42 42" fill="none"
                  ...
                  <g clip-path="url(#clip0_1_41)">
                    ...
                    <path
                      ...
                      fill="#E33629" />
                    <path
                      d="M1.06968 16.8984C1.43501 15.0864 2.042 13.3317 2.87436 11.6812L9.6764 16.9608C8.78681 19.5812 8.78681 22.422 9.6764 25.0425C7.41015 26.7925 5.1428 28.5512 2.87436 30.3187C0.791265 26.1723 0.155956 21.4479 1.06968 16.8984Z"
                      fill="#F8BD00" />
                    <path
                      d="M21.4167 17.1117H40.9467C41.6144 20.7767 41.4337 24.5459 40.4184 28.1302C39.4841 31.4261 37.669 34.4051 35.1684 36.7467C32.9733 35.0339 30.7683 33.3342 28.5731 31.6214C29.6614 30.8873 30.5903 29.9411 31.3041 28.8393C32.0179 27.7376 32.502 26.5031 32.7272 25.2099H21.4167C21.4134 22.5127 21.4167 19.8122 21.4167 17.1117Z"
                      fill="#587DBD" />
                    <path
                ...
                <svg class="logos-facebook" width="42" height="42" viewBox="0 0 42 42" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="bi-github" width="42" height="42" viewBox="0 0 42 42" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div class="frame-9">
            <div class="already-registered-login">Already have an account?
              <router-link class="text-info" to="/signin">
                Sign in
              </router-link>
            </div>
...
.roll-the-carpet {
  color: #ffffff;
  text-align: left;
  font: 600 96px "Noto Sans", sans-serif;
  position: absolute;
  left: 60px;
  top: 381px;
}
...
.skip-the-lag {
  color: #ffffff;
  text-align: left;
  font: 400 italic 32px "Noto Sans", sans-serif;
  position: relative;
}
...
.ellipse-2 {
  ...
  transform: rotate(-28.5deg) scale(1, 1);
}

.frame-2 {
  background: var(--glass-1-fill-carey,
      linear-gradient(-38.77deg,
        rgba(191, 191, 191, 0.06) 0%,
        rgba(0, 0, 0, 0) 100%),
      linear-gradient(to left, rgba(0, 0, 0, 0.14), rgba(0, 0, 0, 0.14)));
  border-radius: 20px;
  border-width: 1px;
  border-style: solid;
  border-image: var(--glass-1-stroke-carey,
      linear-gradient(166.93deg,
...
.signup2 {
  color: #ffffff;
  text-align: left;
  font: 600 36px "Noto Sans", sans-serif;
  position: relative;
}
